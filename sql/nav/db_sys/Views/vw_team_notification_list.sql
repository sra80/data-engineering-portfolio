...
select
    ...
    concat('Please <a href="https://hspan.sharepoint.com/:u:/r/sites/BusinessIntelligenceAlerts/Shared%20Documents/',replace(tnc.channel_name,' ','%20'),'/',lower(tnl.place_holder),'.html?csf=1&web=1&e=2OnSjA">click here</a> to view the message.<p style="font-size:8px; ">',tnl.ID,'</p>') sharepoint_url,
